...
export class WordGenerator {
	...
	constructor(seed: string, options: optionFlags = DEFAULT_OPTIONS, time: number = DEFAULT_TIME) {
	...
	generateWord(): string {
		...
		else if (this.random() < CAPITAL_CHANCE) word = word.charAt(0).toUpperCase() + word.slice(1);
